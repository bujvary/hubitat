 ...
 *    2022-03-28  Brian Ujvary    Added basic authentication options
 * 
 */
...
metadata {
    ...
    preferences {
        ...
        input(name: "httpAuthEnabled", type: "bool", title:"Requires Basic Authentication?", description: "Enable if HTTP basic authentication is required", defaultValue: false, required: true, displayDuringSetup: true)
        if (httpAuthEnabled) {
			input("httpUser", "string", title:"HTTP User", description: "Enter the basic username", required: false, displayDuringSetup: true)
			input("httpPassword", "string", title:"HTTP Password", description: "Enter the basic password", required: false, displayDuringSetup: true)
		}
